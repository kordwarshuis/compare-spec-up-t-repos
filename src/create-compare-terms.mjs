...
const createCompareTerms = async (fileName, menu) => {
    try {
...
<body>
    <div class="container">
        ...
        ${menu}
        <h1 class="mb-4 text-primary">Compare the terms in two repos</h1>
